...
namespace KouArge.Core.Services
{
    public interface IGeneralAssemblyApplyService : IService<GeneralAssemblyApply>
    {
        ...
        Task<CustomResponseDto<GeneralAssemblyApplyDto>> AddAsync(GeneralAssemblyApply generalAssemblyApply);
        ...
        Task<CustomResponseDto<IEnumerable<GeneralAssemblyApplyWithUserDto>>> GetAllWithUserAsync();

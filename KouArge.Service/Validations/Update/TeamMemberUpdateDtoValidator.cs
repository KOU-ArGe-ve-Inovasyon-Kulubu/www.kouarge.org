...
{
    public class TeamMemberUpdateDtoValidator : AbstractValidator<TeamMemberUpdateDto>
    {
        public TeamMemberUpdateDtoValidator()
        {
            ...
            RuleFor(x => x.GeneralAssemblyApplyId).NotNull().WithMessage("{PropertyName} alanı boş geçilemez.").NotEmpty().WithMessage("{PropertyName} alanı boş geçilemez.");
